...
def main():
    ...
    df = pd.DataFrame(dict(sigma=sigma_list, residues=residues, poles=poles,poly_type=poly_type,error_next=error_next,rel_error=rel_error,pole_2=pole_2,res_2=res_2))
