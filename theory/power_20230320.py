...
def calc_V_G(kappa_list,s,sel_grad=1.0,L=1e6,mu=1e-8,d=2,D=1,N=10000):
...
def power_all(sigma,s,sigma_vals,kappa_list,
              res_vals,pole_vals,
              sigma2R=0.1,sigma2G=1.0,Nval=10000,n=1e6,a=1e-8,L=1e6,mu=1e-8,d=2,D=1,l=1,sel_grad=1.0):
